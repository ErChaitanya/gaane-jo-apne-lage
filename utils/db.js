...
export async function getFavorites() {
  try {
    ...
    console.warn('DB Error in getFavorites:', e);
    return [];
  }
}
...
export async function addFavorite(song) {
  try {
    ...
    console.warn('DB Error in addFavorite:', e);
  }
}
...
export async function removeFavorite(songId) {
  try {
    ...
    console.warn('DB Error in removeFavorite:', e);
  }
}
...
export async function isFavorite(songId) {
  try {
    ...
    console.warn('DB Error in isFavorite:', e);
    return false;
  }
}
...
export async function getRecentlyPlayed() {
  try {
    ...
    console.warn('DB Error in getRecentlyPlayed:', e);
    return [];
  }
}
...
export async function addRecentlyPlayed(song) {
  try {
    ...
    console.warn('DB Error in addRecentlyPlayed:', e);
  }
}
...
export async function savePreference(key, value) {
  try {
    ...
    console.warn('DB Error in savePreference:', e);
  }
}
...
export async function getPreference(key, defaultValue = null) {
  try {
    ...
    console.warn('DB Error in getPreference:', e);
    return defaultValue;
  }
}
